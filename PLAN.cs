...
namespace ZooSimulator
{
    class PLAN
    {
        ...
        //      например: крестики-нолики 5х5. возможность 3-4 игроков, 
        //      разные символы (звездочки, треугольники и прочее) 
        //      если ничья поле расширяется
        // 16. Игра с доступом через браузер (адрес сайта)
        //
        // 17. Превратить наш сайт в приложение под телефон (PWA)
    }
}
